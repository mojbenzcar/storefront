...
import storefront.business.LineItem;
import storefront.business.Cart;
import storefront.business.Product;
import java.io.*;
import javax.servlet.*;
import javax.servlet.http.*;

/* this class displays the cart using cart.jsp. when updates are made to the cart from cart.jsp
 * it loops back onto this servlet. Also, clicking any Add to Cart link leads here.
 *
 */
...
public class DisplayCartServlet extends HttpServlet
{
            ...
            throws IOException, ServletException
    {
        ...
        {
            //for now I'll forward to the jsp anyways, it seems weird to go to 
            //quick order when explicitly asked to view cart
